...
SELECT * FROM models
ORDER BY year OFFSET 14 LIMIT 10;
...
SELECT m.year, m.name, m.model_id, a.name FROM models m
...
SELECT b.name, b.founded FROM brands b
...
SELECT m.name, m.year FROM models m
